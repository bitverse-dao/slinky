...
// yymm x/prices market map fetcher and a x/marketmap fetcher. The fetcher
...
type SwitchOverFetcher struct {
	...
	// yymmPricesFetcher is the fetcher for the yymm x/prices market map.
...
// yymm x/prices and x/marketmap fetchers.
func NewDefaultSwitchOverMarketMapFetcher(
	...
	// Construct the yymm x/prices API handler.
	...
	// Construct the yymm x/marketmap API handler.
