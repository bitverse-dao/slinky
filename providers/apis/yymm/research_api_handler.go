...
func researchJSONToQueryAllMarketsParamsResponse(research yymmtypes.ResearchJSON) (yymmtypes.QueryAllMarketParamsResponse, error) {
...
func marketParamFromResearchJSONMarketParam(marketParam yymmtypes.ResearchJSONMarketParam) (yymmtypes.MarketParam, error) {
