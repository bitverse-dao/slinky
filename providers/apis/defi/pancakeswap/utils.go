...
const (
	// Name is the name of the pancakeswap V3 API.
	Name = "pancakeswap_api"

	// ContractMethod is the contract method to call for the Uniswap V3 API.
	ContractMethod = "slot0"

	// BSC_URL is the URL for the Uniswap V3 API. This uses a free public RPC provider on Ethereum Mainnet.
	BSC_URL = "https://bsc.blockpi.network/v1/rpc/public"
)
